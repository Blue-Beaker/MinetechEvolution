...
Updated HadEnoughItems. In case any texture of this mod missing (like the '+' button), Please remove `config/stellarcore_stitcher_cache_jei.dat` to regenerate texture caches for it.
...
Optimization:
- Replaced Clumps with Stackie, for better compatibility
